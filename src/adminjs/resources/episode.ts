...
export const episodeResourceFeatures: FeatureType[] = [
  uploadFileFeature({
    ...
    properties: {
      key: 'videoUrl', // Coluna do banco de dados que representa a URL
      file: 'uploadVideo'
    },
    uploadPath: (record, filename) => `videos/course-${record.get('courseId')}/${filename}` // Caminho depois da pasta 'uploads'
  })
]